...
#     - Store and manage live match data from APIs  
#     - Perform **CRUD operations** (Create, Read, Update, Delete) on MySQL tables  
#     - Explore and visualize match details in an easy UI  
...
#     with col1:
#         st.info("📊 **View Data**\n\nBrowse all database tables with ease.")
#     with col2:
#         st.success("🗄️ **CRUD Operations**\n\nEasily insert, update, or delete records.")
#     with col3:
#         st.warning("📈 **Analytics**\n\nComing soon: Charts & insights from match data.")

#     st.markdown("---")
#     st.subheader("🚀 Quick Start")
#     st.write("👉 Use the **sidebar menu** to start exploring the database.")
